...
const RULES = {
  ...
  Hazard: {
    ...
    urgentKw: ['ไฟไหม้', 'เพลิงไหม้', 'เพลิง', 'ระเบิด', 'น้ำท่วมหนัก', 'น้ำท่วมฉับพลัน', 'แก๊สรั่ว', 'แก็สรั่ว', 'ดินถล่ม', 'พายุ', 'ไฟไหม้บ้าน', 'ไฟไหม้ตึก', 'ไฟไหม้ห้าง', 'รถชน', ''],
    mediumKw: []
  },
  Water: {
    base: 'medium',  // ท่อน้ำ = medium โดย default
    urgentKw: ['น้ำพุ่ง', 'น้ำไหลท่วม', 'ท่อระเบิด', 'น้ำท่วมถนน', 'น้ำไม่ไหล', 'น้ำไม่ไหลเลย', 'ท่อแตก', 'ท่อระเบิด',],
    mediumKw: ['ท่อแตก', 'ท่อรั่ว', 'น้ำไม่ค่อยไหล', 'น้ำไม่ออก', 'น้ำเน่า', 'น้ำเสีย', 'อุดตัน']
  },
  Electricity: {
    base: 'medium',
    urgentKw: ['ไฟช็อต', 'ไฟดูด', 'ไฟรั่ว', 'สายไฟขาด', 'เสาไฟล้ม', 'ไฟระเบิด', 'ไฟดูด', 'เสาไฟล้ม', 'เสาไฟฟ้าล้ม', 'สายไฟฟ้าขาด', 'เสาไฟฟ้าพัง', 'สายไฟฟ้าแรงสูงขาด', 'หม้อแปลงระเบิด', 'สายไฟไหม้', 'ไฟสาธารณะดับ', 'ไฟดับทั้งซอย', 'ไฟดับทั้งหมู่บ้าน', 'ไฟดับทั้งตำบล', 'ไฟดับทั้งอำเภอ', 'ไฟดับทั้งจังหวัด'],
    mediumKw: ['ไฟดับ', 'ไฟไม่ติด', 'ไฟกะพริบ', 'ไฟสาธารณะไม่ติด']
  },
  Road: {
    base: 'normal',
